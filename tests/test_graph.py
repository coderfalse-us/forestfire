...
class TestPathVisualizer:
            ...
            return_value=(
                ...
                [
                    Route(picker_id=0, locations=[(0, 0), (10, 10)],
                          cost=14.14, assigned_orders=[0, 3]),
                    Route(picker_id=1, locations=[(10, 10), (20, 20)],
                          cost=14.14, assigned_orders=[1, 4]),
                    Route(picker_id=2, locations=[(20, 20), (30, 30)],
                          cost=14.14, assigned_orders=[2])
                ],
    ...
    @patch('forestfire.plots.graph.PathVisualizer.save_plot')
    def test_plot_routes_with_empty_solution(self, mock_save_plot,
                                           path_visualizer):
